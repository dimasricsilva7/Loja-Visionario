...
import { CardIcon, CloseIcon, DashboardIcon, LogoutIcon, MenuIcon, OrdersIcon, ProductsIcon, SettingsIcon, TagIcon } from "@/components/icons";
...
const links = [
  ...
  { href: "/admin/parcelamento", label: "Parcelamento", Icon: CardIcon },
